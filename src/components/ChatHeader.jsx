  ...
  return (
    <header className="w-full border-b-border-color p-4 flex items-center gap-4">
      ...
      <div className="flex items-center gap-4 group relative">
        ...
        <div className="hidden md:block invisible group-hover:visible absolute group-hover:delay-500 transition-all duration-200 opacity-0 group-hover:opacity-100 bg-chat-bg bottom-0 p-2 rounded-md translate-y-full text-sm">
